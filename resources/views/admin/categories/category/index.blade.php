                        ...
                        <div class="d-flex justify-content-center justify-content-md-end align-items-baseline">
                            <div
                                ...
                                <div class="dt-buttons btn-group flex-wrap"><button
                                        ...
                                        tabindex="0" aria-controls="DataTables_Table_0" type="button" onclick="window.location='{{ route('categories.create') }}'"><span><i
                                                class="ti ti-plus ti-xs me-0 me-sm-2"></i><span
                                                class="d-none d-sm-inline-block">Add Category</span></span></button> </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <td class="sorting_1">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-wrapper me-3 rounded-2 bg-label-secondary">
                                                <div class="avatar"> <img src="{{ $category->image }}" alt="IMAGE"
                                                        class="rounded-2"></div>
                                            </div>
                                            <div class="d-flex flex-column justify-content-center"><span
                                                    class="text-heading text-wrap fw-medium">{{ $category->name }}</span><span
                                    ...
                                    <td>
                                        <div class="d-flex align-items-sm-center justify-content-sm-center"><button
                                                class="btn btn-icon btn-text-secondary rounded-pill waves-effect waves-light"><i
                                                    class="ti ti-edit" onclick="window.location='{{ route('categories.edit', $category->id) }}'"></i></button><button
