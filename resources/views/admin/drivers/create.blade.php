        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            <div class="mb-6">
              ...
              <select class="form-select" id="driver-country" name="country_id">
            ...
            <div class="mb-6">
              ...
              <select class="form-select" id="driver-region" name="region_id">
            ...
            <div class="mb-6">
              ...
              <select class="form-select" id="driver-city" name="city_id">
            ...
            <div class="mb-6">
              ...
              <select class="form-select" id="driver-district" name="district_id">
